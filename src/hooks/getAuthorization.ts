...
import { SparkAPPID, SparkAPIKey, SparkAPISecret } from "@/config/authKey";
//这里是讯飞星火大模型工作台的个人信息
export const APPID = SparkAPPID;
export const APIKey = SparkAPIKey;
export const APISecret = SparkAPISecret;
/**
 * 大模型版本对照表
 ...
 */
export const domain = "4.0Ultra"
const version = "v4.0/chat"
